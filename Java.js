function PysenPage() {
    const button = document.querySelector('.ButtonPolly');
...
function PollyPage() {
    const button = document.querySelector('.ButtonPysen');
    document.getElementById("changedImgPysen").src = "Images/IMG_8186.JPG";
